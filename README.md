<div align="center">
  <img src="./assets/header.svg" alt="David Morales Guerrero" width="100%" />
</div>

<div align="center">
  <a href="https://www.linkedin.com/in/david-morales-guerrero-0b9849262/">LinkedIn</a>
  &nbsp;&nbsp;·&nbsp;&nbsp;
  <a href="https://github.com/Dave2826?tab=repositories">Repositories</a>
  &nbsp;&nbsp;·&nbsp;&nbsp;
...
<table>
<tr>
<td width="33%"><strong>Backend</strong><br>C# · .NET · ASP.NET MVC · Python</td>
<td width="33%"><strong>Data</strong><br>SQL · PostgreSQL · Database Design</td>
<td width="33%"><strong>APIs & Cloud</strong><br>REST APIs · AWS · Cloud Operations</td>
</tr>
<tr>
...
<a href="https://github.com/Dave2826/Atlas">View repository →</a>
...
<a href="https://github.com/Dave2826/MotoMods-API">View repository →</a>

</td>
<td width="50%">

### Software architecture & academic projects
...
C#, .NET, ASP.NET MVC, Python, REST APIs, CRUD operations, business logic and application architecture.
...
SQL, PostgreSQL, relational modeling, normalization, database design, queries and structured data management.
...
AWS fundamentals, Cloud Operations, Linux, Git, GitHub and practical IT infrastructure knowledge.
...
I am open to software development opportunities, Dual-program placements, internships, collaborative projects and technical conversations.
...
<div align="center">
  <sub>Software Development Student · IT Technician · Mérida, Yucatán, Mexico</sub>
</div>
